...
public class Resoueces {
    ...
    static public final String styleProtectedSnakeHead = "-fx-background-color: #FFFF00;";
    static public final String styleNoProtectedSnakeHead = "-fx-background-color: #00FF00;";
